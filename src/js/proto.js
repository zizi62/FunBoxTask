...
function Student(name, lastName, stats){
    Person.call(this, name, lastName);
    this.stats = stats;
}
Student.prototype = Person.prototype;

var person = new Person("Mike", "Mayers");
var student = new Student("vova","pupkin", "junior");
*/
...
//     constructor(name, lastName, stats){
//         super(name, lastName);
//         this.stats = stats;
//     }
//     toString(){
//         return super.toString() + " " + this.stats;
//     }

// }

// var person2 = new Person("Mike", "Mayers");
// var student2 = new Student("vova", "pupkin", "junior");
